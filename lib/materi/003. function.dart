...
class Functions {
  ...
  // Named Function.
  // Pengertian : Ini adalah fungsi yang dideklarasikan dengan nama tertentu. Anda dapat memanggilnya berulang kali menggunakan nama tersebut.
  ...
  // Lambda Function.
  // Pengertian : Ini adalah cara singkat untuk mendefinisikan fungsi anonim dalam satu baris. Ini juga dikenal sebagai fungsi anonim.
  double luasSegiempat(double panjang, double lebar) => panjang * lebar;

  // Anonymous Function
  // Pengertian : Ini adalah fungsi tanpa nama yang bisa dibuat di dalam kode, biasanya digunakan sebagai parameter untuk fungsi lain.
